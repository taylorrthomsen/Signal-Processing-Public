function [finalOut] = chat_callFreshAnalysis_inputSafety_10rec_062725(filepath, ch_height, De_np, wC, thresholds)
    % User-friendly version of callFreshAnalysis6Rec with safe input handling
%ch_height=23.5; De_np =  24.71766479; wC = 9; thresholds = [15,100];filepath = '/Users/taylorthomsen/Library/CloudStorage/GoogleDrive-taylorthomsen@berkeley.edu/Shared drives/Sohn Research Lab/Project Folders/Endo/withdrawal 070425/070425_hESC_hormone_day3_p6_80mbar_9umwc_4a_try1/preproc';
%changed wNP in frechanalysis6rec
    ...
    [~, locs] = findpeaks(window, 'MinPeakHeight', 3000, 'MinPeakDistance', 7000); %original height 1000 and distance 9000
    ...
    for i = 1:length(locs)
        ...
        while true
            ...
            endidx = min(length(yas2det), round(endidx));
            ...
            [OUT_array] = freshAnalysis(Rf, yas2det, startidx, endidx, sampleRate, ch_height, De_np, wC, thresholds, false, false);
